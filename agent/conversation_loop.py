        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if response_invalid:
                    ...
                    # Backoff before retry — configurable Hermes retry schedule with jitter.
                    wait_time = jittered_backoff(
                        retry_count,
                        base_delay=getattr(agent, "_api_retry_base_delay", 3.0),
                        max_delay=getattr(agent, "_api_retry_max_delay", 90.0),
                        multiplier=getattr(agent, "_api_retry_multiplier", 1.8),
                    )
